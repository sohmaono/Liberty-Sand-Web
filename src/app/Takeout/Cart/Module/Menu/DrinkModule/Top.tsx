...
export default function CartMenuDrinkModuleTop(props: { drink: DrinkType }) {
  const { drink } = props;
  return (
    <div className="flex flex-col md:flex-row justify-between items-center md:gap-[10px] gap-5 w-full">
